(() => {
  ...
  var ChartType = /* @__PURE__ */ ((ChartType3) => {
    ...
    ChartType3[ChartType3["Bubble"] = 6] = "Bubble";
    return ChartType3;
  })(ChartType || {});
  ...
  // src/x_y_hor_vert_axis.ts
  var _onXAxisLabelGroupClickScoped, _onXAxisLabelGroupKeypressScoped, _xAxisGroupElement, _xAxisLabelsGroupElement, _xAxisGridColumnsSelectableGroupElement, _addXAxisLine, addXAxisLine_fn, _onXAxisLabelGroupClick, onXAxisLabelGroupClick_fn, _onXAxisLabelGroupSelect, onXAxisLabelGroupSelect_fn, _onXAxisLabelGroupKeypress, onXAxisLabelGroupKeypress_fn;
  var XYHorVertAxisController = class {
    /**
     * @param svgChart SvgChart instance.
     */
    constructor(svgChart) {
    ...
    onDrawStart() {
      ...
      const columnWidth = this.config.xAxisGridColumns ? this.svgChart.chartWidth / this.svgChart.data.xAxis.columns.length : this.svgChart.chartWidth / (this.svgChart.data.xAxis.columns.length - 1);
    ...
    addXAxisLabelsGroup() {
      ...
      if (this.config.xAxisGridColumnsSelectable) {
        ...
        this.svgChart.addEventListener(this.xAxisLabelsGroupElement, "click", __privateGet(this, _onXAxisLabelGroupClickScoped), false);
        this.svgChart.addEventListener(this.xAxisLabelsGroupElement, "keydown", __privateGet(this, _onXAxisLabelGroupKeypressScoped), false);
  ...
  var _getCurvedPathFromPoints, getCurvedPathFromPoints_fn, _closePath, closePath_fn, _getStraightPathFromPoints, getStraightPathFromPoints_fn;
  ...
  var _radius, _centerX, _centerY, _seriesCount, _degreeSteps, _radiusByXStep, _axisGroupElement, _drawAxis, drawAxis_fn;
  ...
  var _radiusPerZValue;
  var BubbleController = class extends Controller {
    /**
     * @param svgChart - SvgChart instance.
     */
    constructor(svgChart) {
  ...
  var _SvgChart = class {
    ...
    setConfig(config) {
      ...
      __privateSet(this, _controller, new (__privateGet(_SvgChart, _chartTypeControllers))[config.chartType](this));
  ...
  (() => {
    ...
    __privateGet(_SvgChart, _chartTypeControllers)[6 /* Bubble */] = BubbleController;
  })();
  /**
  ...
  function dynamicChart() {
    ...
    const config = (0, eval)("(" + document.getElementById("chartDynamicCodeConfig").value + ")");
