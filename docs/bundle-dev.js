(() => {
    ...
    "src/axis.ts"() {
      ...
      AxisController = class {
        ...
        addXAxisGridAndLabels(columnWidth) {
          ...
          directionForEach(this, this.svgChart.data.xAxis.columns, this.svgChart.isLTR, (colValue, colIndex) => {
    ...
    "src/charts/line_chart_controller.ts"() {
      ...
      LineController = class extends Controller {
        ...
        onDrawSerie(serie, serieIndex, serieGroup) {
          ...
          directionForEach(this, this.svgChart.data.series[serie.id], this.svgChart.isLTR, (value, valueIndex, values) => {
  ...
  var init_config = __esm({
    "src/config.ts"() {
      ...
      SvgChartConfig = _SvgChartConfig;
      SvgChartConfig.directions = {
        ltr: "ltr",
        rtl: "rtl"
      };
  ...
  var require_app_svg = __commonJS({
    "docs/app_svg.js"(exports, module) {
      ...
      var htmlDir = document.documentElement.getAttribute("dir") in SvgChartConfig.directions ? SvgChartConfig.directions[document.documentElement.getAttribute("dir")] : SvgChartConfig.directions.ltr;
      var chartInfo = {
        chartBasicLine: {
          config: {
            chartType: "line",
